...
!function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a="function"==typeof require&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}for(var i="function"==typeof require&&require,o=0;o<r.length;o++)s(r[o]);return s}({1:[function(require,module,exports){(function(){var Tile,Tiles,stubs;Tiles=require("./components/Tiles.coffee"),Tile=require("./components/Tile.coffee"),stubs=[1,2,3],React.render(React.createElement(Tiles,{data:stubs}),document.getElementById("game"))}).call(this)},{"./components/Tile.coffee":2,"./components/Tiles.coffee":3}],2:[function(require,module,exports){(function(){var R,Tile;R=React.DOM,Tile=React.createClass({displayName:"Tile",render:function(){return R.li({className:"tile"},R.span(null,"X"))}}),module.exports=Tile}).call(this)},{}],3:[function(require,module,exports){(function(){var R,Tile,Tiles;Tile=require("./Tile.coffee"),R=React.DOM,Tiles=React.createClass({displayName:"Tiles",render:function(){var tiles;return tiles=this.props.data.map(function(item){return React.createElement(Tile,null)}),R.ul({id:"board"},tiles)}}),module.exports=Tiles}).call(this)},{"./Tile.coffee":2}]},{},[1]);
